...
proof
  show "\<And>x y. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
           y \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
           x \<otimes>\<^bsub>add_monoid rec_rng_of_frac\<^esub> y
    ...
    by (smt mem_Collect_eq monoid.select_convs(1) partial_object.select_convs(1) rec_rng_of_frac_def 
        set_eq_class_of_rng_of_frac_def)
  show "\<And>x y z. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
             y \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
             z \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
             x \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
             y \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
             z =
             x \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
             (y \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub> z)"
    using assoc_add_rng_of_frac
    by (smt mem_Collect_eq monoid.simps(1) partial_object.select_convs(1) rec_rng_of_frac_def 
        set_eq_class_of_rng_of_frac_def)
  show "\<one>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
    \<in> carrier (add_monoid rec_rng_of_frac)"
  ...
  show "\<And>x. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
         \<one>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub> \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
         x =
         x"
  ...
  show "\<And>x. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
         x \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub>
         \<one>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub> =
         x"
  ...
  show "\<And>x y. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
           y \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
           x \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub> y =
           y \<otimes>\<^bsub>(add_monoid rec_rng_of_frac)\<^esub> x"
    using comm_add_rng_of_frac
    by (smt mem_Collect_eq monoid.select_convs(1) partial_object.select_convs(1) rec_rng_of_frac_def 
        set_eq_class_of_rng_of_frac_def)
  show "carrier (add_monoid rec_rng_of_frac)
    \<subseteq> Units (add_monoid rec_rng_of_frac)"
  proof
    show "\<And>x. x \<in> carrier (add_monoid rec_rng_of_frac) \<Longrightarrow>
         x \<in> Units (add_monoid rec_rng_of_frac)"
    proof-
      fix x
      assume a1:"x \<in> carrier (add_monoid rec_rng_of_frac)"
